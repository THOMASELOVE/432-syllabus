...
To contact the TAs, email `431-help at case dot edu`, which is open starting Tuesday January 16.

## Office Hours for TAs

Teaching Assistant Office Hours are held in WG-56 (Computing Lab) or WG-67 (Student Lounge) on the ground floor of the Wood building, so be sure to look in both places if you need help. Office hours will begin in the second week of classes, and a full schedule will be announced before that date. 
...
```{r Terry-fig, echo = FALSE, out.width = '33%'}
